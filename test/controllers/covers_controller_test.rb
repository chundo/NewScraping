...
class CoversControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cover" do
    assert_difference('Cover.count') do
      post covers_url, params: { cover: { action_url: @cover.action_url, image: @cover.image, name: @cover.name, status: @cover.status, sumary: @cover.sumary } }
    end
  ...
  test "should update cover" do
    patch cover_url(@cover), params: { cover: { action_url: @cover.action_url, image: @cover.image, name: @cover.name, status: @cover.status, sumary: @cover.sumary } }
